...
INSERT INTO `barang` VALUES (22,'sendok',2000,0),(23,'pensil',1000,0),(24,'piring',10000,0),(25,'sabun',2500,0);
...
INSERT INTO `karyawan` VALUES (2,'billy bonkas','0841239417','Jl. PuKer 19','billy','bonka','admin'),(3,'WDASS','0843423','Jl brerer','streamz','e80b5017098950fc58aa','karyawan'),(5,'arianto','081423','puncak kertajaya','leonspirit','pyupyupyu','inaktif');
...
INSERT INTO `penjualan` VALUES (1,1,'2016-10-10','2016-10-15',100000,2,NULL,NULL,NULL),(2,1,'2016-10-08','2016-10-13',100000,2,NULL,NULL,NULL),(3,1,'2016-05-05','2016-05-11',100000,3,NULL,NULL,NULL),(4,1,'2016-05-05','2016-05-11',100000,3,NULL,NULL,NULL),(5,1,'2016-05-05','2016-05-11',100000,3,NULL,NULL,NULL),(6,1,'2016-05-05','2016-05-11',100000,3,NULL,NULL,NULL);
...
INSERT INTO `penjualanbarang` VALUES (1,3,5,10,50,0,NULL),(2,4,5,10,50,0,NULL),(3,4,2,15,10,0,NULL),(4,5,5,10,50,0,NULL),(5,5,2,15,10,0,NULL),(6,6,5,10,50,0,NULL),(7,6,2,15,10,0,NULL);
...
CREATE TABLE `satuanbarang` (
  ...
  `acuan_satuan` int(11) DEFAULT NULL,
  `satuanpembelian` int(11) DEFAULT NULL,
...
INSERT INTO `satuanbarang` VALUES (1,23,1000,'biji',1,NULL,NULL),(2,23,10000,'lusin',12,NULL,NULL),(3,23,44000,'kardus',50,NULL,NULL),(4,25,4000,'biji',1,NULL,NULL),(5,25,20000,'setengah lusin',6,NULL,NULL),(6,25,65000,'pak',20,NULL,NULL);
...
INSERT INTO `token` VALUES (1,'5fc7eb9a-611d-48b4-ab4d-c28a1d','inaktif',2),(2,'0b684473-3db0-47c6-9231-b4c38e','inaktif',2),(3,'37f6ec2e-6822-4a5a-b075-600dd4','aktif',2),(4,'48089457-eb58-4fcc-88d7-60dee1','inaktif',3),(5,'e3ff576e-7a00-4269-88b6-7c498e','aktif',3),(6,'e4d1201c-c3d5-4c8e-9f47-ee3c69','inaktif',3),(7,'accf97ab-cfdd-4a3d-b561-027829','aktif',3);
...
-- Dump completed on 2016-10-03 20:01:44
