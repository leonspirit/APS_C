...
function PopulatePenjualanKecilInvoice(id)
{
    var currentToken = localStorage.getItem("token");
    GetDetailPenjualan(currentToken, id, function(result){
        var  itemPenjualanBesarTable;// =$("#Detailpenjualan-ItemTable").DataTable();
        ...
        if (result.token_status=="success") {
            ...
            if (!$.fn.DataTable.isDataTable("#PenjualanKecilItemTable")) {
                itemPenjualanBesarTable = $("#PenjualanKecil-ItemTable").DataTable({
                    "paging": false,
                    "lengthChange": false,
                    "searching": false,
                    "ordering": false,
