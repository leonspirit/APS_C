...
INSERT INTO `barang` VALUES (20,'garpu',200,NULL),(21,'piring',800,NULL);
...
INSERT INTO `karyawan` VALUES (2,'billy bonkas','0841239417','Jl. PuKer 19','billy','bonka','asisten'),(3,'WDS','08941234','Jl. TPI 42','streamz','sembah','karyawan');
...
INSERT INTO `pelanggan` VALUES (1,'Arianto Wibowo','0839183234','Jl Babatan Mutki M 72'),(2,'Billy Bonka','08314923','Jl Puker 19'),(4,'pyupyupyu','08123423','Jl. PyuPyuPyu');
...
CREATE TABLE `pembelianbarang` (
  ...
  `satuanpembelianID` int(11) DEFAULT NULL,
  ...
  KEY `SATUAN_PEMBELIAN_FK` (`satuanpembelianID`),
  CONSTRAINT `PEMBELIAN_FK` FOREIGN KEY (`pembelianID`) REFERENCES `pembelian` (`pembelianID`),
  CONSTRAINT `SATUAN_PEMBELIAN_FK` FOREIGN KEY (`satuanpembelianID`) REFERENCES `satuanpembelian` (`satuanpembelianID`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `satuanbarang` VALUES (15,20,1500,'biji',1),(16,21,5500,'biji',1),(17,21,30000,'lusin',12),(18,21,300000,'dus',50),(19,20,50000,'dus',50),(20,20,50000,'dus',50);
/*!40000 ALTER TABLE `satuanbarang` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `satuanpembelian`
--

DROP TABLE IF EXISTS `satuanpembelian`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `satuanpembelian` (
  `satuanpembelianID` int(11) NOT NULL AUTO_INCREMENT,
  `barangID` int(11) DEFAULT NULL,
  `satuan` varchar(20) DEFAULT NULL,
  `konversi` int(11) DEFAULT NULL,
  PRIMARY KEY (`satuanpembelianID`),
  KEY `BARANG_PEMBELIAN_FK` (`barangID`),
  CONSTRAINT `BARANG_PEMBELIAN_FK` FOREIGN KEY (`barangID`) REFERENCES `barang` (`barangID`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `satuanpembelian`
--

LOCK TABLES `satuanpembelian` WRITE;
/*!40000 ALTER TABLE `satuanpembelian` DISABLE KEYS */;
/*!40000 ALTER TABLE `satuanpembelian` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `supplier` VALUES (1,'PT BOnka','03184239','Chocolate Fektori'),(3,'PT. Billi\'s','084123482','Jl. Coklat Faktory');
...
-- Dump completed on 2016-09-26  8:48:31
